...
import torch
import torchvision
from depth.models.modules import E_resnet, E_densenet, E_senet
from depth.models.resnet import resnet18, resnet34, resnet50, resnet101, resnet152
from depth.models.densenet import densenet161, densenet121, densenet169, densenet201
from depth.models.senet import senet154, se_resnet50, se_resnet101, se_resnet152, se_resnext50_32x4d, se_resnext101_32x4d
import pdb
...
def get_models(backbone_net, pretrained_dir):
	backbone = backbone_net

	if os.getenv('TORCH_MODEL_ZOO') != pretrained_dir:
		os.environ['TORCH_MODEL_ZOO'] = pretrained_dir
	else:
		pass
