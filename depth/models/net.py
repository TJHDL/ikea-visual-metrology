...
import numpy as np
from depth.models import modules
from depth.models import get_models
...
class SARPN_APP(nn.Module):
	def __init__(self, pretrained_dir):
		super(SARPN_APP, self).__init__()
		# print("backbone:", 'SENet154')
		self.feature_extraction = get_models('SENet154', pretrained_dir)
